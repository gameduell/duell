...
class duell_commands_BuildCommand:
	...
	def buildNewExecutableWithBuildLibAndDependencies(self):
		...
		while (_g < len(_g1)):
			...
			_g = (_g + 1)
			buildArguments.append("-cp")
			x2 = duell_helpers_DuellLibHelper.getPath(l.lib.name)
