...
class duell_commands_UpdateCommand:
    ...
    __slots__ = ("finalLibList", "finalPluginList", "finalToolList", "haxelibVersions", "duellLibVersions", "sourceLibVersions", "pluginVersions", "buildLib", "platformName", "duellToolGitVers", "duellToolRequestedVersion", "isDifferentDuellToolVersion", "targetPlatform", "currentXMLPath")
